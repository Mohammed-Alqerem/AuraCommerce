...
- Date: 2026-08-25
- Working branch: `feature/admin-header-navigation`
- Base: `feature/excel-sales-report` at `93a1321` (stacked feature branch)
- Current increment: consistent title-first admin page headers with shared navigation directly beneath the title context
