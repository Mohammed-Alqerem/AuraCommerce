(function () {
    ...
    const translations = {
        en: {
            ...
            "login.externalUnavailable": "Unavailable options activate after secure provider setup.",
            "login.continueEmail": "or continue with email",
            "login.email": "Email",
        ...
        ar: {
            ...
            "login.externalUnavailable": "تُفعّل الخيارات غير المتاحة بعد إعداد المزوّد الآمن.",
            "login.continueEmail": "أو تابع باستخدام البريد الإلكتروني",
